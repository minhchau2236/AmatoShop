               ...
               <div class="sp-slide">
                    <div class="col-md-8 img_banner"><img class="sp-image" data-bind="attr: { src: '/Services/GetArticleImage.ashx?Id=' + Id, retina: '/Services/GetArticleImage.ashx?Id=' + Id }"></div>
  	                <div class="sp-caption col-md-4 tin_banner ">
                        ...
                        <p>Lúc 14 giờ chiều 12/01/2016 (03-12-Ất Mùi) tại Văn phòng 2 TƯGH (thiền viện Quảng Đức, TP.HCM), Ban TTTT. T.Ư đã tổ chức hội nghị tổng kết phật sự 2015 và thông qua chương trình  phật sự năm 2016.</p>
