...
namespace PSCPortal.Services
{
    ...
    public class CMS : System.Web.Services.WebService
    {
        ...
        [System.Web.Services.WebMethod(EnableSession = true)]
        public string CreateContractor(string ContractorName, string ContractorNumber, string TaxCode, string BusinessCategory, int Size, float Capital, string ContractorPhoneNumber, string Fax, string ContractorAddress, string ContractorProvinces, string ContractorNation, string WebSite, string ContractorEmail, string UserName, string Password, string UserEmail, string FirstName, string LastName, string UserPhoneNumber, string IndentityCard, bool Gender, DateTime BirthDay, string UserAddress, string UserProvinces, string UserNation, string Position, string Department)
        {
            Contractor cont = new Contractor();
            cont.ContractorId = Guid.NewGuid();
            cont.ContractorName = ContractorName;
            cont.ContractorNumber = ContractorNumber;
            cont.TaxCode = TaxCode;
            cont.BusinessCategory = BusinessCategory;
            cont.Size = Size;
            cont.Capital = Capital;
            cont.ContractorPhoneNumber = ContractorPhoneNumber;
            cont.Fax = Fax;
            cont.ContractorAddress = ContractorAddress;
            cont.ContractorProvinces = ContractorProvinces;
            cont.ContractorNation = ContractorNation;
            cont.WebSite = WebSite;
            cont.ContractorEmail = ContractorEmail;
            cont.UserName = UserName;
            cont.Password = Password;
            cont.UserEmail = UserEmail;
            cont.FirstName = FirstName;
            cont.LastName = LastName;
            cont.UserPhoneNumber = UserPhoneNumber;
            cont.IndentityCard = IndentityCard;
            cont.Gender = Gender;
            cont.BirthDay = BirthDay;
            cont.UserAddress = UserAddress;
            cont.UserProvinces = UserProvinces;
            cont.UserNation = UserNation;
            cont.CreateContractor();

            return "Thừ tạo nhà thầu";
        }
    }
}
